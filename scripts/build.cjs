...
for (const [i, group] of groups.entries()) {
  ...
  const css = ['notes-2020.css','simulations.css','note-labs.css','notes-study.css','notes-core.css',...(chapter.number>=6?['notes-extended.css']:[]),'notes-choices.css'];
  const scripts = [`generated/chapter${chapter.number}.js`,'simulations.js','notes-choices.js','note-labs-runtime.js','note-labs.js','note-labs-2021.js','note-labs-audit.js',...(modules[chapter.number] ? [`note-labs-${modules[chapter.number]}.js`] : []),'notes-app.js'];
