  ...
  Object.assign(scenes, {
    ...
    y2020q43(demo) {
      const pages=[
        ...
        office('Word','花卉介绍.docx','开始','<span>已选中手动换行符</span>','<div class="word-page v24-break-page"><p>荷花，又名莲花，出淤泥而不染。<button data-sim-step="2" class="delete-break">Delete</button><br><b>牡丹，花大色艳，素有花中之王之称。</b></p></div>'),
        office('Word','花卉介绍.docx','开始','<span>两段暂时合并</span>','<div class="word-page v24-break-page"><p>荷花，又名莲花，出淤泥而不染。<button data-sim-step="3" class="caret-enter">在此按 Enter</button>牡丹，花大色艳，素有花中之王之称。</p></div>'),
        office('Word','花卉介绍.docx','开始','<span>段落标记已插入</span>','<div class="word-page v24-break-page fixed"><p>荷花，又名莲花，出淤泥而不染。¶</p><p>牡丹，花大色艳，素有花中之王之称。¶</p><button data-sim-step="4" class="verify-indent">检查首行缩进</button></div>'),
    ...
    y2020q41(demo) {
      ...
      return `<div class="v25-stage-shell v24-word-stages"><section data-v25-stage="0">${office('Word','花卉图鉴.docx','开始','<span>正在编辑第1节</span>',page('荷花','牡丹','<button data-sim-step="0" class="section-caret">在“牡丹”前放置光标</button>'))}</section><section data-v25-stage="1">${office('Word','花卉图鉴.docx','布局','<div class="break-menu"><button data-sim-step="1">分隔符 → 下一页分节符</button></div>',page('荷花','牡丹','<span class="section-break-mark">:::::::: 分节符（下一页） ::::::::</span>'))}</section><section data-v25-stage="2">${office('Word','花卉图鉴.docx','页眉和页脚工具/设计','<span>第2节</span>',page('<button data-sim-step="2" class="edit-header">双击页眉：荷花</button>','牡丹','<small class="same-as-previous">与上一节相同</small>'))}</section><section data-v25-stage="3">${office('Word','花卉图鉴.docx','页眉和页脚工具/设计','<button data-sim-step="3" class="ribbon-command active">链接到前一节</button>',page('荷花','牡丹','<small class="same-as-previous">即将解除链接</small>'))}</section><section data-v25-stage="4">${office('Word','花卉图鉴.docx','页眉和页脚工具/设计','<span>链接到前一节：关闭</span>',page('<button data-sim-step="4" class="rename-header">把“荷花”改为“牡丹”</button>','牡丹'))}</section><section data-v25-stage="5"><div class="v24-section-spread"><article><header>荷花</header><b>第1节</b></article><article><header>牡丹</header><b>第2节</b></article></div></section></div>${feedback('分页符只能换页；只有分节后关闭“链接到前一节”，页眉才真正独立。')}`;
    },
    y2020q57(demo) {
      const stages=[
