(() => {
  ...
  document.body.insertAdjacentHTML('afterbegin', `
    ...
    <header class="site-header">
      <a class="brand" href="./index.html?v=11"><span class="brand-mark">20</span><span class="brand-copy"><strong>计算机系统笔记</strong><small id="brand-chapter">2020真题来源</small></span></a>
      <div class="header-actions"><label class="chapter-select-wrap"><span class="sr-only">切换章节</span><select id="chapter-select" aria-label="切换章节"></select></label><button id="open-drawer" type="button">本章目录</button></div>
    </header>
    ...
    <main id="main-content">
      <section class="chapter-intro" id="chapter-top">
        ...
        <div class="chapter-meta"><span id="chapter-count"></span><span>2020年真题来源</span></div>
      </section>
    ...
    <footer class="site-footer"><a href="./index.html?v=11">全部章节</a><a href="https://www.sdzk.cn/NewsInfo.aspx?BCID=1195&amp;CID=1133&amp;NewsID=7081" target="_blank" rel="noreferrer">现行考试要求</a></footer>`);
  ...
  $('#chapter-select').addEventListener('change', event => { location.href = `./chapter${event.target.value}.html?v=11`; });
  $('#note-list').innerHTML = notes.length ? notes.map(note => `<li><a href="#q${note.q}"><span>第${note.q}题</span><b>${note.title}</b></a></li>`).join('') : '<li class="empty-note-list">2020年没有命中本章知识点</li>';
